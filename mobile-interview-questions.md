...
- [x] Why you changed your focus from `<working_topic_I>` to `<working_topic_II>`?
- [x] In which role do you see yourself at `<company>`?
- [x] What are your goals in your first year at `<company>`?
...
- [x] Have you ever been in a situation where you had to do something you never did before? How did you react and what did you learn?
...
- [x] Which 3 aspects are most important for you in a job.
...
- [x] Describe a situation where you felt stressed and overwhelmed. What do you do in such a situation?
- [x] How do you decide how much time is needed for a user story?
...
- [x] Which was your biggest carreer goal? Why?
...
- [---] Which of your apps are avalable in the store?
...
- [iOS] What are your options when you need to do automated UI-Tests with Xcode? `[XCUITest]`
...
- [iOS] In how many projects you used Swift?
- [iOS] Did you already migrated projects from Obj-C to Swift? Waht was the greatest challenge?
- [Android] In how many projects you used Kotlin?
- [Android] Did you already migrated projects from Java to Kotlin? Waht was the greatest challenge?
